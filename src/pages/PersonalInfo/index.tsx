...
const PersonalInfo: React.FC = () => {
  ...
  function findDeviceById(devices: any, id: any) {
    const device = devices.find((dvc: any) => dvc.id === id);
    return device || null;
  }
    ...
    <PageContainer>
      ...
      >
        ...
        >
          ...
          <Descriptions.Item label="借用费率">{currentRow?.deviceName}</Descriptions.Item>
          <Descriptions.Item label="购买日期">{currentRow?.deviceName}</Descriptions.Item>
          <Descriptions.Item label="资产编号">{currentRow?.deviceName}</Descriptions.Item>
          <Descriptions.Item label="预计报废时间">{currentRow?.deviceName}</Descriptions.Item>
          <Descriptions.Item label="设备参数">{currentRow?.deviceName}</Descriptions.Item>
          <Descriptions.Item label="设备图片列表">{currentRow?.deviceName}</Descriptions.Item>
        </Descriptions>
      </Modal>
    </PageContainer>
  );
